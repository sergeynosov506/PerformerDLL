...
*/
  ...
  #define PERFORMDATE 1 // 12/31/1899
	...
	// initialization) and their value should match to that in Delphi(StarsIODefinitions)
 ...
 typedef struct {
	...
	typedef struct
	{
		...
		double	fAccrInt;
		double	fAnnDivCpn;
		// it is possible that the price of a security is not found, but its exchange rate 
		// is found, next flag is to indicate whether the price on this record is valid or not
		BOOL		bIsPriceValid; 
		BOOL		bIsExrateValid;
		char		sCurrId[4+NT];
  ...
  typedef void			(CALLBACK* LPPR5PDBL5PCHAR1LONG)(double *, double *, double *, double *, double *,
																										 char *, char *, char *, char *, char *, long, ERRSTRUCT *);
  ...
  typedef void			(CALLBACK* LPPRSELECTONEACCDIV)(ACCDIV *, int, long, long, ERRSTRUCT *);
	typedef void		  (CALLBACK* LPPRSELECTALLACCDIV)(ACCDIV *, int *, double *, double *, double *,
  ...
  typedef void      (CALLBACK* LPPRFETCHHMAPCURSOR)(long *, char *, char *, char *, char *, char * ,ERRSTRUCT *);
  ...
  typedef void			(CALLBACK* LPPRSELECTHOLDINGS)(HOLDINGS *, int , char *, char *, char *, char *, long, ERRSTRUCT *);
	typedef void			(CALLBACK* LPPRALLHOLDINGSFORANACCOUNT)(int, HOLDINGS *, ERRSTRUCT *);
	typedef void			(CALLBACK* LPPRHOLDINGSPOINTER)(HOLDINGS *, ERRSTRUCT *);
	typedef void			(CALLBACK* LPPRHSUMSELECT)(double *, double *, double *, double *, double *, 
																							int, char *, char *, char *, char *, long, ERRSTRUCT *);
  typedef void		  (CALLBACK* LPPRHSUMUPDATE)(double, double, double, double, double,
																					     char *, long, char *, int, char *,
...
//  typedef void      (CALLBACK* LPPRSELECTDAILYROR)(RTRNSET *, int, ERRSTRUCT *);
  ...
  typedef void			(CALLBACK* LPPRTRANSSELECT)(TRANS *, char *, int *, char *, int, long, long, ERRSTRUCT *);
  ...
  typedef ERRSTRUCT	(CALLBACK* LPFNTRANALLOC)(TRANS *, TRANTYPE, SECTYPE, ASSETS, 
	...
	// updatehold function
  typedef ERRSTRUCT	(CALLBACK* LPFNUPDATEHOLD)(TRANS, PORTMAIN, DTRANSDESC[], int, char *, BOOL);
...
// 	typedef void      (CALLBACK* LPPRMONTHLYWEIGHTEDINFO)(SUMMDATA *, RTRNSET *, long, long,  ERRSTRUCT *);
  typedef void      (CALLBACK* LPPRSELECTPERFORMANCEHOLDINGS)(PARTHOLDING *, int, char *, ERRSTRUCT *);
  typedef void      (CALLBACK* LPPRSELECTPERFORMANCEHOLDCASH)(PARTHOLDING *, int, char *, ERRSTRUCT *);
  typedef void      (CALLBACK* LPPRSELECTPERFORMANCETRANSACTION)(PARTTRANS *, int, long, long, ERRSTRUCT *);
  typedef void      (CALLBACK* LPPRSELECTDAILYSUMMDATA)(SUMMDATA *, long, long, ERRSTRUCT *);
  typedef void      (CALLBACK* LPPRSELECTPERIODSUMMDATA)(SUMMDATA *, long, long, long, ERRSTRUCT *);
  ...
  typedef void      (CALLBACK* LPPRREADALLHOLDMAP)(char *, char *, char *, char *, char *, char *, long *, ERRSTRUCT *);
  ...
  typedef ERRSTRUCT (CALLBACK* LPPRTESTASSET)(PARTASSET zPartAsset, PSCRDET *pPerfScrDetail, int iNumDetail, 
																							BOOL bSecCurr, long lDate, BOOL *pbResult);

  typedef ERRSTRUCT (CALLBACK* LPPRINITPERFORMANCE)(long lAsofDate, char *sDBAlias, char *sMode, char *sType, 
																										BOOL bPrepareQueries, char *sErrFile);

  typedef void      (CALLBACK* LPPRDELETEHOLDCASH)(int, char *, char *, char *, char *, ERRSTRUCT *);

  typedef void      (CALLBACK* LPPRDELETEHOLDINGS)(int, char *, char *, char *, char *, long, ERRSTRUCT *);

  typedef void      (CALLBACK* LPPRSELECTCOMPOSITE)(int, long, int *, ERRSTRUCT *);

  typedef void      (CALLBACK* LPPRDELETEHOLDINGSHOLDCASH)(int, char *, char *, char *, BOOL, ERRSTRUCT *);
