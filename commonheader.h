 ...
 *   - Adds DLLAPI/STDCALL macros and C exports for
 * InitializeErrStruct/PrintError
...
typedef ERRSTRUCT(CALLBACK *LPFN1INT2PCHAR4LONG2DOUBLE1BOOL1PDOUBLE)(
    int, char *, char *, long, long, long, long, double, double, BOOL,
    double *);
...
typedef void(CALLBACK *LPPR1INT4PCHAR2LONG)(int, char *, char *, char *, char *,
                                            long, long, ERRSTRUCT *);
typedef void(CALLBACK *LPPR1INT4PCHAR2LONG1PDOUBLE)(int, char *, char *, char *,
                                                    char *, long, long,
                                                    double *, ERRSTRUCT *);
typedef void(CALLBACK *LPPR1INT4PCHAR3LONG1PDOUBLE)(int, char *, char *, char *,
                                                    char *, long, long, long,
                                                    double *, ERRSTRUCT *);
...
typedef void(CALLBACK *LPPR1LONG3PCHAR1BOOL)(long, char *, char *, char *, BOOL,
                                             ERRSTRUCT *);
typedef ERRSTRUCT(CALLBACK *LPFN1LONG3PCHAR1BOOL1PCHAR)(long, char *, char *,
                                                        char *, BOOL, char *);
...
typedef void(CALLBACK *LPPR3LONG1PLONG1PINT)(long, long, long, long *, int *,
                                             ERRSTRUCT *);
...
typedef void(CALLBACK *LPPR4LONG2PCHAR2PLONG2PDOUBLE)(long, long, long, long,
                                                      char *, char *, long *,
                                                      long *, double *,
                                                      double *, ERRSTRUCT *);

typedef void(CALLBACK *LPPR1PLONG5PCHAR)(long *, char *, char *, char *, char *,
                                         char *, ERRSTRUCT *);
...
typedef void(CALLBACK *LPPR2PCHAR1PINT1PCHAR)(char *, char *, int *, char *,
                                              ERRSTRUCT *);
typedef void(CALLBACK *LPPR2PCHAR1LONG1PDOUBLE1PLONG)(char *, char *, long,
                                                      double *, long *,
                                                      ERRSTRUCT *);
typedef void(CALLBACK *LPPR2PCHAR3LONG1PCHAR)(const char *, const char *, long,
                                              long, long, const char *,
                                              ERRSTRUCT *);
typedef void(CALLBACK *LPPR2PCHAR4LONG1PCHAR)(const char *, const char *, long,
                                              long, long, long, const char *,
                                              ERRSTRUCT *);
...
typedef void(CALLBACK *LPPR5PCHAR2LONG)(char *, char *, char *, char *, char *,
                                        long, long, ERRSTRUCT *);
typedef void(CALLBACK *LPPRR6PCHAR1PLONG)(char *, char *, char *, char *,
                                          char *, char *, long *, ERRSTRUCT *);
typedef void(CALLBACK *LPPR8PCHAR1PLONG)(char *, char *, char *, char *, char *,
                                         char *, char *, char *, long *,
                                         ERRSTRUCT *);

typedef double(CALLBACK *LPFN1DOUBLE3PCHAR1LONGINT)(double, char *, char *,
                                                    char *, long, int);
...
typedef void(CALLBACK *LPFNSELECTNEXTCALLDATEPRICE)(char *, char *, double *,
                                                    long *, ERRSTRUCT *);
...
DLLAPI ERRSTRUCT STDCALL PrintError(const char *sErrMsg, int iID, long lRecNo,
                                    const char *sRecType, int iBusinessErr,
                                    int iSqlErr, int iIsamCode,
                                    const char *sMsgIdentifier, BOOL bWarning);
