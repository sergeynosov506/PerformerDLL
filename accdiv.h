...
typedef void	(CALLBACK* LPPRALLACCDIVFORANACCOUNT)(int, long, long, PARTACCDIV *, ERRSTRUCT *);
typedef void	(CALLBACK* LPPRPENDINGACCDIVTRANSFORANACCOUNT)(int, long, PARTACCDIV *, ERRSTRUCT *);
typedef int	  (CALLBACK* LPFNACCDIVTABLE)(ACCDIVTABLE, int, BOOL, long, long, char *, char *, char *, 
																					char *, long);
