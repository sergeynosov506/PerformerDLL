...
typedef void (CALLBACK* LPPRSELECTCURRENCYSECNO)(char*,char*,int*,char*,ERRSTRUCT*);
typedef BOOL (CALLBACK* LPFNITSMANUALPRICESECURITY)(char*,char*,long,ERRSTRUCT*);
...
extern LPFNVOID								lpfnStartTransaction, lpfnRollbackTransaction, lpfnCommitTransaction;
...
extern LPPRPENDINGACCDIVTRANSFORANACCOUNT	lpprSelectPendingAccdivTransForAnAccount;
...
ERRSTRUCT	ValueHedgexref(int iID, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, 
						   CUSTOMPRICETABLE zCPTable, PRICETABLE *pzPTable, PHXREFTABLE *pzPXTable);
ERRSTRUCT	ValueHoldings(PARTPMAIN zPmain, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, PHXREFTABLE zPXTable, 
						  CUSTOMPRICETABLE zCPTable, PORTBAL *pzPbal, PBALXTRA *pzPbxtra, PRICETABLE *pzPTable, BOOL bPartialValuation);
ERRSTRUCT	ValueHoldcash(PARTPMAIN zPmain, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, CUSTOMPRICETABLE zCPTable,
						  PORTBAL *pzPbal, PBALXTRA *pzPbxtra, PRICETABLE *pzPTable, BOOL bPartialValuation);
ERRSTRUCT	ValuePayrec(int iID, long lPriceDate, double fBaseXrate,SECTYPETABLE zSTTable, 
						CUSTOMPRICETABLE zCPTable, PRICETABLE *pzPTable);
ERRSTRUCT	ValuePortbal(int iID, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, PORTBAL zPbal, 
						 PBALXTRA zPbxtra, CUSTOMPRICETABLE zCPTable, PRICETABLE *pzPTable);
void		UpdatePBFromHoldings(HOLDINGS zHold, SECTYPE zSType, BOOL bCAvail, BOOL bFAvail, PORTBAL *pzPbal, PBALXTRA *pzPbxtra);
void		UpdatePBFromHoldcash(HOLDCASH zHcash, BOOL bCAvail, PORTBAL *pzPbal, PBALXTRA *pzPbxtra);
ERRSTRUCT	UpdatePBFromAccdiv(ACCDIV zAccdiv, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, PRICETABLE *pzPTable, PORTBAL *pzPbal);
ERRSTRUCT	UpdatePBFromTrans(TRANS zTrans, long lPriceDate, double fBaseXrate, SECTYPETABLE zSTTable, PRICETABLE *pzPTable, PORTBAL *pzPbal);
double		GetAccruedInterest(const long lPriceDate,HOLDINGS zTempHold,CUSTOMPRICETABLE zCPTable, PRICETABLE *pzPTable,BOOL bLastBusinessDay);
...
double		StraightLineDiscountedAccrual(double fTotCost, double fParAmount, long lStlDate, long lMaturityDate, long lPricingDate);
...
ERRSTRUCT	GetSecurityPrice(char *sSecNo, char *sWi, long lPriceDate, SECTYPETABLE zSTable, int iID,
							 CUSTOMPRICETABLE zCPTable, PRICETABLE *pzPTable, PRICEINFO *pzPrice);
...
ERRSTRUCT	FillAccdivTable(int iID, BOOL bIncome, BOOL bIncByLot, long lPriceDate, ASSETTABLE *pzATable, ACCDIVTABLE *pzAccdivTable);
// down to here
