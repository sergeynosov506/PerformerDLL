...
//new needs for maturity. All above defined in dipay	
  ...
  typedef void (CALLBACK* LPFNINITIALIZEPINFOTABLE)(PINFOTABLE *);
	typedef ERRSTRUCT (CALLBACK* LPFNBUILDPINFOTABLE)(PINFOTABLE *, char *, long, char *);
	typedef char * (CALLBACK* LPFNMAKEPRICINGFILENAME)(long, char *, char *, char *);
	typedef BOOL (CALLBACK* LPFNFILEEXISTS)(char *);
	typedef void (CALLBACK* LPFNINITIALIZEDTRANSDESC)(DTRANSDESC *);
	typedef void (CALLBACK* LPFNSTYPESTATEMENT)(SECTYPE *, ERRSTRUCT *);
	typedef void (CALLBACK* LPFNMATUNLSTATEMENT)(MATSTRUCT *, long, long, char *, char *, char *, char *, char *, ERRSTRUCT *);
...
ERRSTRUCT BuildMatTable(char *sMode, char *sFileName, char *sBrAcct, 
                        char *sSecNo, char *sWi, char *sSecXtend, 
                        char *sAcctType, long lStartDate, long lvalDate,
                        long lStartingPosition, MATTABLE *pzMatTable);
